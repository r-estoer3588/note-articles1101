...
俺も昔は知らなくて、情報不足で損する選択をするで大損した。

でも「正しい情報で最適な選択をする」に切り替えただけで人生変わった。マジで。
...
情報不足で損する選択をするで、業者の言いなりで、比較もせずに。
**全部カモられてる**。
